This is an ecommerce demo project built using [Next.js](https://nextjs.org/), [Tailwind](https://tailwindcss.com), [Firebase](https://firebase.google.com) and [Stripe](https://stripe.com).
